/*
 * @Author: [Xiaoheng Xia]
 * @Date: 2022-04-14 00:28:48
 * @LastEditors: [Xiaoheng Xia]
 * @LastEditTime: 2022-04-24 20:41:33
 * @FilePath: /519021911248/Part\ B/519021910341-seq-full.hcl
 * @Description: 
 *
 * In this file we added the IADDL instruction.
 * 
 * Xiaoheng Xia | xia.xh@sjtu.edu.cn | 519021910341
 * Copyright (c) 2022 by Xiaoheng Xia, All Rights Reserved. 
 */
...
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	       IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, IIADDL }; # IIADDL SHOULD BE VALID

# Does fetched instruction require a regid byte?
bool need_regids =
	icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL, IIADDL }; # IIADDL NEEDS REGID BYTE
# Does fetched instruction require a constant word?
bool need_valC =
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, IIADDL }; # IIADDL NEEDS VALC
...
int srcB = [
	icode in { IOPL, IRMMOVL, IMRMOVL, IIADDL  } : rB; # IIADDL'S SRCB SHOULD BE rB
...
int dstE = [
	...
	icode in { IIRMOVL, IOPL, IIADDL } : rB; # IIADDL'S DSTE SHOULD BE rB
	icode in { IPUSHL, IPOPL, ICALL, IRET } : RESP;
...
int aluA = [
	...
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL } : valC; # IIADDL'S ALUA SHOULD BE valC
...
int aluB = [
	icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		      IPUSHL, IRET, IPOPL, IIADDL } : valB; # IIADDL'S ALUB SHOULD BE valB
...
bool set_cc = icode in { IOPL, IIADDL }; # IIADDL'S CONDITION CODE SHOULD BE UPDATED
