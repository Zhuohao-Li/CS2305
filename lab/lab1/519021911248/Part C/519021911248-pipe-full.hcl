 ...
 * @Date: 2022-04-23 21:36:36
 * @LastEditors: [Zhuohao Lee, Xiaoheng Xia]
 * @LastEditTime: 2022-04-24 20:53:25
 * @FilePath: /519021911248/Part C/519021911248-pipe-full.hcl
 * @Description: edith_lzh@sjtu.edu.cn | xia.xh@sjtu.edu.cn
 *
 * Like what we have done in Part B, we added iaddl to the pipeline design. It avoided
 * the overhead of using registers to store constants, and also increased the number of registers
 * we could use, which paved the way for our further optimization. This is the main work we did in .hcl file
 *
